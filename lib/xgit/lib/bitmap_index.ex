defprotocol Xgit.Lib.BitmapIndex do
  @moduledoc ~S"""
  A compressed bitmap representation of the entire object graph.

  PORTING NOTE: The jgit implementation has an abstract class `BitmapIndex` with
  a concrete implementation named `BitmapIndexImpl`. There are no other implementations
  of that abstract class. I’ve taken here the liberty of removing that abstraction
  and porting only the implementation.

  OPTIMIZATION NOTE: The jgit implementation uses efficient bitmap sets (EWAH set).
  There is no comparable implementation available for Erlang or Elixir as of this
  writing and I don't have time or patience to write one. I'm bootstrapping using
  MapSet for now. A PR to improve this would be welcome.
  """
